<template>
    <div class="flex flex-col min-h-screen dark:bg-black dark:text-white">
        <div class="overflow-hidden relative flex items-center">
            <div id="slider" class="flex w-screen transition-all duration-500"
                :style="{ transform: `translateX(-${currentIndex * 100}%)` }">
                <img src="/assets/slider/slide5.webp" alt="" class="min-w-full h-[25vh] md:h-[50vh]">
                <img src="/assets/slider/slide6.webp" alt="" class="min-w-full h-[25vh] md:h-[50vh]">
                <img src="/assets/slider/slide7.webp" alt="" class="min-w-full h-[25vh] md:h-[50vh]">
                <img src="/assets/slider/slide8.webp" alt="" class="min-w-full h-[25vh] md:h-[50vh]">
                <img class="min-w-full h-[25vh] md:h-[50vh]"
                    srcset="//file.hstatic.net/200000065946/collection/collection_page_547ea00a778b49dfbfa089ced2e12319_large.jpg"
                    alt="Ưu Đãi">
            </div>
            <div @click="prevSlide" class="absolute left-0 cursor-pointer animate-pulse text-black">
                <VueIcon type="mdi" :path="mdiChevronLeft" size="70" />
            </div>
            <div @click="nextSlide" class="absolute right-0 cursor-pointer animate-pulse text-black">
                <VueIcon type="mdi" :path="mdiChevronRight" size="70" />
            </div>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 py-2">
            <div class="flex flex-col items-center gap-5 p-10">
                ...
                <p>Với kinh nghiệm hơn 24 năm trong hoàn thiện nội thất, Nhà Xinh mang đến giải pháp toàn diện trong bao
                    gồm thiết kế, trang trí và cung cấp nội thất trọn gói. Sở hữu đội ngũ chuyên nghiệp và hệ thống 10
                    cửa hàng, Nhà Xinh là lựa chọn cho không gian tinh tế và hiện đại.</p>
                <a href=""
                    class="border-2 p-2 border-green-500 text-xl font-bold hover:text-white hover:bg-green-500">Xem
                    thêm</a>
            </div>
            <div class="">
        ...
        <div class="flex flex-col p-5 md:p-10 gap-5">
            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="flex w-full overflow-hidden relative">
                    <div id="blog"
                        class="flex w-[calc(100vw-40px)] gap-5 md:gap-10 transition-transform duration-[3000ms] translate-x-0"
                        :style="{ transform: `translateX(-${indexBlog * (windowWidth >= 768 ? 25 : 50)}%)` }">
                        <div v-for="(item, index) in commentView" :key="index"
                            class="w-[calc(50%-20px)] md:w-[calc(25%-43px)] flex-shrink-0 border">
                            ...
                            <div class="flex flex-col gap-3 p-3">
                                <div class="flex flex-col items-center">
                                    ...
                                    <star-rating v-model="item.comments[0].rate" :star-size="20" :show-rating="false"
                    ...
                    <div @click="nextBlog" class="absolute -right-10 self-center">
                        <VueIcon type="mdi" :path="mdiChevronRight" size="50" />
                    </div>
                </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 dark:bg-black dark:text-white">
                <div class="flex flex-col items-center border p-5 text-gray-500 dark:text-white">
                    <img src="https://theme.hstatic.net/200000065946/1001264503/14/vice_item_1_thumb.png?v=330"
                        width="50" hight="50" alt="">
